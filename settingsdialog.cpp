...
SettingsDialog::SettingsDialog(SidDatabase *db, QWidget *parent) : QDialog(parent)
{
    ...
    QString rom_default_path = Qmmp::configDir() + "sidplayfp";
    m_ui.romPathLineEdit->setText(settings.value("rom_path", rom_default_path).toString());
...
void SettingsDialog::accept()
{
    ...
    settings.setValue("rom_path", m_ui.romPathLineEdit->text());
